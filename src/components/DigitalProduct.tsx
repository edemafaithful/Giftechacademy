            ...
            <div className="p-10 md:p-20 text-white">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                  Get Hired Faster with Our <span className="text-pink-100">Resume Bundle</span>
                </h2>
                <p className="text-blue-100 text-lg mb-8 leading-relaxed">
                  Stop getting rejected by ATS systems. Our professional Resume and Cover Letter bundle is designed to help you land more interviews.
                </p>
                ...
                <div className="flex flex-wrap items-center gap-6">
                  <div className="text-3xl font-bold">{ACADEMY_CONFIG.resumePrice}</div>
                  <a
